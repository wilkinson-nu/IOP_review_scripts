...
def make_q0_comp(inputDir="inputs/", det="T2KND", flux="FHC_numu", outdir="plots/"):
    ...
    make_generator_comp(outdir+"/"+det+"_"+flux+"_"+targ+"_q0_gencomp.pdf", inFileList, nameList, colzList, lineList, "q0", binning, ehad_cut, \
                        "q_{0} (GeV); d#sigma/dq_{0} (#times 10^{-38} cm^{2}/GeV/nucleon)", withRebin=True, legDim=[0.65, 0.44, 0.93, 0.93])
        
if __name__ == "__main__":

    parser = argparse.ArgumentParser("make_q0_comp")
