#!/bin/bash
#SBATCH --image=docker:wilkinsonnu/nuisance_project:nuwro_25.03.1
#SBATCH --account=dune
#SBATCH --qos=shared
...
shifter -V ${PWD}:/output --entrypoint nuwro -i ${INCARD} -o ${OUTFILE}
shifter -V ${PWD}:/output --entrypoint PrepareNuWroEvents ${OUTFILE} -F ${FLUX_FILE},${FLUX_HIST},${NU_PDG}
